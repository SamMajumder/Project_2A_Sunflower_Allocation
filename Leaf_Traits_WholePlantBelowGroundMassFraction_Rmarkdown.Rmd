...
########## METHOD 1 #### Step AIC
set.seed(1234)
M_regression <- lm(WPBMF~., data = train_standard)
...
write.csv(important_var_m_regression,"D:/Drive_C_2_18_21/PhD_WORK/Chapter_2/Leaf_traits_driving_destructive_traits/whole_plant_below_ground_mass_fraction/M_regression/FEATURE_SELECTION/M_regression_whole_plant_belowground_mass_fraction.csv")
...
M_regression_new <- train(WPBMF~., data = train_new,method='lm')
